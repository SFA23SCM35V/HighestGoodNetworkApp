...
export const isBefore = (date1, date2) => moment(date1).tz(LA_TIME_ZONE).isBefore(moment(date2).tz(LA_TIME_ZONE));
export const dateOneDayBefore = (date) => moment(date).subtract(1, 'days').tz(LA_TIME_ZONE).format('YYYYMMDD');